	...
	const historyToggle = (
		<CollapsibleTrigger asChild>
			<span className="inline-flex">
				<IconActionButton label={t(open ? "history.hide" : "history.show")}>
					{open ? (
						<>
						...
						<div className="flex items-center gap-2">
							...
							<Switch
								...
								onCheckedChange={(checked) => {
									if (checked !== myAssignmentsOnly) toggleMyAssignmentsOnly();
								}}
							/>
							{historyToggle}
						</div>
						...
						<>
							...
							>
								...
								{visibleHistory.map((item, index) => {
									...
									const isRealAssignment = !item.skipped && !item.isAbsentSkip;
									...
									return (
										<article
											...
											className={cn(
												...
												!showAll && index >= visibleHistoryCount && "invisible",
											)}
										>
