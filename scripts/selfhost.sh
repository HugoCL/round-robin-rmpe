...
BACKEND_ENV_KEYS="CLERK_JWT_ISSUER_DOMAIN VAPID_PRIVATE_KEY VAPID_EMAIL NEXT_PUBLIC_VAPID_PUBLIC_KEY ADMIN_ALLOWLIST_EMAILS EMAIL_ACCESS_ALLOWED_DOMAINS EMAIL_ACCESS_ALLOWED_PATTERN EMAIL_ACCESS_ALLOW_CLERK_TEST_EMAILS"
